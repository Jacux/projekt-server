const updateQuestStatus = async (req, res) => {
  try {
    ...
    // Robisz ze dodaje typowi w bazie danych streaka + 1 (dodatkowa baza ze streakami, idTypa [mongodb uid czy jakos tak], ilosc) Musisz sprawdzic czy ma aktywny rekord czy dodac nowy
